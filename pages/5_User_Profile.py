...
def change_status(is_public):
    ...
    existing_user_data.loc[existing_user_data['Username'] == f'{st.session_state["username"]}', 'Profile Public'] = not is_public  # Toggle the value
...
if authentication_status:
    ...
    current_user = st.session_state["existing_user_data"].query(f"Username == '{st.session_state['username']}'")
    ...
    # st.session_state.pop("existing_user_data")
